...
public class RecipeUtil {
    public static List<ItemStack> getDisassemblyIngredients(Level level, ItemStack stack) {
        ...
        // Create a copy of the stack without enchantments for recipe matching
        ItemStack stackWithoutEnchantments = stack.copy();
        stackWithoutEnchantments.removeTagKey("Enchantments");
        stackWithoutEnchantments.removeTagKey("StoredEnchantments");
        ...
        Optional<CraftingRecipe> matchingRecipe = recipes.stream()
                .filter(recipe -> {
                    ...
                    return ItemStack.isSameItem(result, stackWithoutEnchantments) || ItemStack.isSameItem(result, stack);
                })
                .findFirst();
