...
public class DisassemblyTableContainer extends AbstractContainerMenu {
    private final DisassemblyTableBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public DisassemblyTableContainer(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()),
                new SimpleContainerData(2));
    }

    public DisassemblyTableContainer(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModContainers.DISASSEMBLY_TABLE_CONTAINER.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DISASSEMBLY_TABLE.get());
    }
